...
(function() {
    ...
    function assignEventListeners() {
        ...
        $('#dark-css').on('click', function () {
            ...
            $('.missing')
                .css('background-image', 'url(metrics-graphics-2.8.0/examples/images/missing-data-dark.png)');
            ...
            $('#dark').attr({href : 'metrics-graphics-2.8.0/examples/css/metricsgraphics-demo-dark.css'});
            $('#dark-code').attr({href : 'metrics-graphics-2.8.0/examples/css/railscasts.css'});
        ...
        $('#light-css').on('click', function () {
            ...
            $('.missing')
                .css('background-image', 'url(metrics-graphics-2.8.0/examples/images/missing-data.png)');
        ...
        $('#accessible-css').on('click', function () {
            $('.head ul li a.pill').removeClass('active');
            $(this).toggleClass('active');
            $('#accessible').attr({href : 'metrics-graphics-2.8.0/examples/css/metricsgraphics-demo-accessible.css'});
